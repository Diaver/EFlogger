...
rem #    run merge cmd
@echo Merging: '"%ILMerge%" /wildcards /targetplatform:%net% /out:"%result%" "%target_dir%*.dll" /lib:%1External\EntityFramework.6.0.2\lib\net40\'
"%ILMerge%" /wildcards /targetplatform:%net% /out:"%result%" "%target_dir%*.dll" /lib:%1External\EntityFramework.6.0.2\lib\net40\
