   ...
   public class EFProfiledDbProviderServices<T> : DbProviderServices where T : DbProviderServices
    {
        ...
        protected override DbCommandDefinition CreateDbCommandDefinition(DbProviderManifest providerManifest, DbCommandTree commandTree)
        {
            ...
            var profiled = cmd.Connection as ProfiledDbConnection;
            if (profiled != null)
            {
                cmd.Connection = new ProfiledDbConnection(cmd.Connection, MiniProfiler.Current);
            }

            return CreateCommandDefinition(new ProfiledDbCommand(cmd, cmd.Connection));
        }
