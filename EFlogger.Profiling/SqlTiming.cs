...
namespace EFlogger.Profiling
{
    ...
    public class SqlTiming
    {
        ...
        public readonly ProfiledDbCommand Command;
        ...
        {
            return _customTiming.CommandString + " (" + _customTiming.DurationMilliseconds + " ms)";
        }
        ...
        /// </summary>
        public void ExecutionComplete(bool isReader, IDataReader reader)
        {
            if (isReader)
            {
            ...
            else
            {
                ...
                Logger.Log(_customTiming.CommandString, (long)durationMilliseconds, _customTiming.StackTraceStackFrame, Command.AffectedRows, _customTiming.StackTraceSnippet);
        ...
        {
            Logger.LogException(exception, (long)_customTiming.DurationMilliseconds.Value, _customTiming.StackTraceStackFrame, 0, _customTiming.StackTraceSnippet);
        }
    }
}