...
namespace EFlogger.EntityFramework4
{
    ...
    public class EFProfiledDbProviderFactory<T> : DbProviderFactory, IServiceProvider where T : DbProviderFactory
    {
        ...
        {
            return new ProfiledDbCommand(_tail.CreateCommand(), null);
        }
     ...
     /*   object IServiceProvider.GetService(Type serviceType)
        {
            ...
            {
                svc = new ProfiledDbProviderServices((DbProviderServices)svc, null);
            }
        ...
        public object GetService(Type serviceType)
        {
            ...
            var provider = (IServiceProvider)_tail;
            var service = provider.GetService(serviceType);
            var dbProviderServices = service as DbProviderServices;

            if (dbProviderServices == null && _tail is SqlClientFactory)
            {
            ...
            if (dbProviderServices != null)
                return new ProfiledDbProviderServices(dbProviderServices, null);
